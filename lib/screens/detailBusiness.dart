...
class _DetailBussinessState extends State<DetailBussiness> {
              ...
              Column(
                children: [
                  Container(
                    ...
                    child: Stack(
                      children: [
                        widget.nearBy.business_images.toString() == "null"
                            ? Container(
                                height: 33.h,
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  ...
                                  widget.nearBy.opening_time.toString() !=
                                          "null"
                                      ? "Opening Hours: " +
                                          widget.nearBy.opening_time.toString()
                                      : "",
                            ...
                            Text(
                              ...
                              widget.nearBy.closing_time.toString() != "null"
                                  ? "Closing Hours: " +
                                      widget.nearBy.closing_time.toString()
                                  : " ",
                              style: TextStyle(
                                  fontSize: 11.sp,
                                  color: Colors.white,
                        ...
                        Text(
                          widget.nearBy.description.toString() == "null"
                              ? ""
                          ...
                          if (result != null) {
                            ...
                            if (currentPath != "") {
                              ...
                              fileName = path.basename(
                                  communityReviewList[index].replyfile!.path);
                              print("Filename " +
                                  communityReviewList[index]
                                      .replyfileName
                                      .toString());
                              ...
                              communityReviewList[index]
                                  .replyfileList
                                  .add(communityReviewList[index].replyfile!);
                              setState(() {});
                            } else {
                              communityReviewList[index].replyfile = null;
                              communityReviewList[index].replyfileName = "";
  ...
  Future<void> pickImagesSlider(int index) async {
    ...
    if (communityReviewList[index].replyimages.length > 0) {
      communityReviewList[index].replyimages.forEach((element) async {
        ...
        communityReviewList[index].replyfileName =
            communityReviewList[index].replyfile!.path.split("/").last;
        communityReviewList[index]
            .replyfileList
            .add(communityReviewList[index].replyfile!);
        setState(() {});
  ...
  Future<dynamic> communityReplyOnReviewApi(
    ...
    if (communityReviewList[index].replyfileList.length > 0) {
      ...
      print("ivStatus: " +
          communityReviewList[index].reply_image_video_status.toString());
      if (communityReviewList[index].reply_image_video_status.toString() ==
          "1") {
      ...
      } else if (communityReviewList[index]
              .reply_image_video_status
              .toString() ==
          "2") {
  ...
  Future<dynamic> businessReviewApi(
    ...
    if (res.statusCode == 200) {
      ...
      if (jsonRes["status"].toString() == "true") {
        ...
        popUps(context, "Review submitted successfully" ," Your review has been posted successfully on "+widget.nearBy.business_name, "Done", onTapp);
      ...
      if (jsonRes["status"].toString() == "true") {
        ...
        if (!jsonRes["message"].toString().contains("You are already")) {
          ...
          if (widget.nearBy.checkIn_status.toString() == "2") {
            ...
            checkoutApi(rattingcheckin.toString(),
                reviewController2.text.toString(), check.toString());
          }
        } else {
