...
class _CommunityRepliesByIdState extends State<CommunityRepliesById> {
  var id = "";
  var created_at = "";
  var review_id = "";
  var message = "";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          isloading==true?ShimmerEffectReview():ListView(
            shrinkWrap: true,
  ...
  Future<dynamic> replyOnHotspotReplyApi(
    ...
    request.fields["business_id"] = detail.buisness_id;
